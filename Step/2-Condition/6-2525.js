...
const fs = require('fs');
const Input = fs.readFileSync("./stdin/6-2525.txt").toString().trim().split('\n');
...
const a = parseInt(Minutes / 60);
const b = Minutes % 60

if(A > 23 || A < 0 || B > 59 || B < 0 || C < 0 || C > 1000) console.log("Wrong inputs");
A + a > 23 ? console.log(A + a - 24, b) : console.log(A + a, b);
